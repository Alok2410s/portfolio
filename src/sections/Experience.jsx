  ...
  return (
    <section className="c-space section-spacing" id="experience">
      ...
      <div className="mt-12 flex flex-col gap-6 relative">
        <div className="absolute left-6 top-0 bottom-0 w-[2px] bg-white/10 hidden md:block" />
        {experiences.map((exp) => (
          <div key={exp.id} className="grid-default-color relative md:ml-12 hover-animation">
            <div className="absolute -left-[54px] top-6 w-4 h-4 rounded-full bg-royal shadow-[0_0_15px_rgba(92,51,204,0.8)] border-2 border-primary hidden md:block" />
